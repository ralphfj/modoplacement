...
$textbody .= 'Sprechen Sie regelmäßig '.$target_langDE.' = '.$howoftenoptions[$howoften]."\n\n";
$textbody .= "Welche Inhalte und welcher Wortschatz sind für Sie wichtig? = \n".$wortschatz."\n\n";
$textbody .= 'In welchen Situationen haben Sie Schwierigkeiten, '.$target_langDE." zu sprechen? = \n".$schwierigkeiten."\n\n";
$textbody .= 'In welchen Situationen sprechen Sie '.$target_langDE.' / Für welche Situationen benötigen Sie '.$target_langDE."? = \n".$situation."\n\n";
...
$sheet->write(3, 1, winchar($target_lang_compound_space), $format_header);
